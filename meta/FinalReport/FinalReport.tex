...
For hardware, I mainly worked on the keyboard controller.  I also worked on the register file with Daniel and the ALU with Jon.  However both of these were relatively simple pieces of hardware.  I also helped Daniel design the control logic.
